...
public abstract class RecentViewHolder extends TViewHolder implements OnClickListener {
    ...
    protected TextView mDraftTpsTextView;//提示为草稿
    ...
    private void updateMsgLabel() {
        ...
        switch (status) {
            case fail:
                ...
                mDraftTpsTextView.setVisibility(View.GONE);
                break;
            case sending:
            ...
            case draft://草稿状态
                ...
                mDraftTpsTextView.setVisibility(View.VISIBLE);
                break;
            default:
                imgMsgStatus.setVisibility(View.GONE);
                mDraftTpsTextView.setVisibility(View.GONE);
    ...
    public void inflate() {
        ...
        this.mDraftTpsTextView = (TextView) view.findViewById(R.id.tv_draft_tips);
    }
